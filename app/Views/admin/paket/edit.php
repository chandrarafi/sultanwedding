...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="<?= base_url('admin/paket/update/' . $paket['kdpaket']) ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field() ?>

                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="namapaket" class="form-label">Nama Paket <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="namapaket" name="namapaket" value="<?= old('namapaket', $paket['namapaket']) ?>" required>
                    </div>
                    <div class="col-md-6">
                        ...
                        <select class="form-control" id="kdkategori" name="kdkategori" required>
                            ...
                            <?php foreach ($kategori as $k) : ?>
                                <option value="<?= $k['kdkategori'] ?>" <?= old('kdkategori', $paket['kdkategori']) == $k['kdkategori'] ? 'selected' : '' ?>>
                                    <?= $k['namakategori'] ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="detailpaket" name="detailpaket" rows="5"><?= old('detailpaket', $paket['detailpaket']) ?></textarea>
                </div>

                <div class="mb-3">
                    <label for="foto" class="form-label">Foto Paket</label>
                    <input type="file" class="form-control" id="foto" name="foto" accept="image/*">
                    <div class="form-text">Format: JPG, JPEG, PNG. Maks: 2MB. Kosongkan jika tidak ingin mengubah foto.</div>
                </div>
                ...
                <?php if (!empty($paket['foto'])) : ?>
                    <div class="mb-3">
                        ...
                        <div class="text-center">
                            <img src="<?= base_url('uploads/paket/' . $paket['foto']) ?>" class="img-fluid img-thumbnail" style="max-height: 200px;">
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <a href="<?= base_url('admin/paket') ?>" class="btn btn-secondary me-md-2">Batal</a>
