...
<div class="card">
    <div class="card-header py-3 d-flex align-items-center justify-content-between">
        <h5 class="mb-0 report-title">Laporan Pemesanan Paket Tahunan: <?= $tahun ?></h5>
        <div class="btn-group">
    ...
    <div class="card-body">
        <form action="<?= site_url('admin/laporan/pemesananPaketTahunan') ?>" method="get" class="mb-4">
            <div class="row g-3">
                <div class="col-md-10">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="<?= site_url('admin/laporan/cetakLaporanPaketTahunan?tahun=' . $tahun) ?>" class="btn btn-primary" target="_blank">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <h6 class="mb-0"><i class="bx bx-bar-chart-alt-2 me-2"></i> Statistik Pemesanan Paket Per Bulan Tahun <?= $tahun ?></h6>
            </div>
            <div class="card-body">
