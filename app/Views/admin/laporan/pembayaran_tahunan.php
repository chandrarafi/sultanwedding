...
<div class="card">
    <div class="card-header py-3 d-flex align-items-center justify-content-between">
        <h5 class="mb-0 report-title">Laporan Pembayaran Tahunan: <?= $tahun ?></h5>
        <div class="btn-group">
    ...
    <div class="card-body">
        <form action="<?= site_url('admin/laporan/pembayaranTahunan') ?>" method="get" class="mb-4">
            <div class="row g-3">
                <div class="col-md-10">
        ...
        <div class="d-flex justify-content-end mb-3">
            <a href="<?= site_url('admin/laporan/cetakLaporanPembayaranTahunan?' . http_build_query([
                            'tahun' => $tahun
        ...
        <div class="card mb-4">
            <div class="card-header">
                <h6 class="mb-0"><i class="bx bx-bar-chart-alt-2 me-2"></i> Statistik Pembayaran Per Bulan Tahun <?= $tahun ?></h6>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            foreach ($bulan as $key => $nama_bulan): ?>
                                <tr>
                                    <td><?= $nama_bulan ?></td>
                                    <td><?= number_format($laporan['pembayaran_bulanan'][$key], 0, ',', '.') ?></td>
                        ...
                        <tfoot>
                            <tr class="table-primary">
                                <th>Total</th>
                                <th><?= number_format($laporan['total_pembayaran'], 0, ',', '.') ?></th>
