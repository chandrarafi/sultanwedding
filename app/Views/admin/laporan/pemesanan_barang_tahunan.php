    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item"><a href="<?= site_url('admin/laporan/pemesananBarang') ?>">Laporan Pemesanan Barang</a></li>
...
<div class="card">
    <div class="card-header py-3 d-flex align-items-center justify-content-between">
        <h5 class="mb-0 report-title">Laporan Pemesanan Barang Tahunan: <?= $tahun ?></h5>
        <div class="btn-group">
    ...
    <div class="card-body">
        <form action="<?= site_url('admin/laporan/pemesananBarangTahunan') ?>" method="get" class="mb-4">
            <div class="row g-3">
                <div class="col-md-10">
        ...
        <div class="d-flex justify-content-end mb-3">
            <a href="<?= site_url('admin/laporan/cetakLaporanBarangTahunan?tahun=' . $tahun) ?>" class="btn btn-success" target="_blank">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <h6 class="mb-0"><i class="bx bx-bar-chart-alt-2 me-2"></i> Statistik Pemesanan Barang Per Bulan Tahun <?= $tahun ?></h6>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            foreach ($bulan as $key => $nama_bulan): ?>
                                <tr>
                                    ...
                                    <td>Rp <?= number_format($laporan['pendapatan_bulanan'][$key], 0, ',', '.') ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                        <tfoot>
        ...
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0"><i class="bx bx-table me-2"></i> Detail Transaksi <?= $tahun ?></h6>
            </div>
            <div class="card-body">
