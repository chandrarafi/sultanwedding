...
<div class="card">
    <div class="card-header py-3 d-flex align-items-center justify-content-between">
        <h5 class="mb-0 report-title">Laporan Pemesanan Barang Bulanan: <?= $nama_bulan ?> <?= $tahun ?></h5>
        <div class="btn-group">
    ...
    <div class="card-body">
        <form action="<?= site_url('admin/laporan/pemesananBarangBulanan') ?>" method="get" class="mb-4">
            <div class="row g-3">
                <div class="col-md-5">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="<?= site_url('admin/laporan/cetakLaporanBarangBulanan?bulan=' . $bulan . '&tahun=' . $tahun) ?>" class="btn btn-primary" target="_blank">
        ...
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0"><i class="bx bx-table me-2"></i>Data Pemesanan Barang - <?= $nama_bulan ?> <?= $tahun ?></h6>
            </div>
            <div class="card-body">
                    ...
                    <table id="dataTable" class="table table-striped table-bordered">
                        ...
                        <tfoot>
                            <tr class="table-primary">
                                ...
                                <th colspan="2" class="text-start">Rp <?= number_format($totalPendapatanCalculated, 0, ',', '.') ?></th>
                            </tr>
                        </tfoot>
                    </table>
                </div>
