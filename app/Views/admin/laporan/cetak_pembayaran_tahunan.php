...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            if (!empty($laporan['pembayaran_bulanan'])) :
                foreach ($laporan['pembayaran_bulanan'] as $bulan => $jumlah) :
                    $totalJumlahPembayaran += $jumlah;
            ?>
                    <tr>
                        <td class="text-center"><?= $no++ ?></td>
                        <td><?= $bulanNames[$bulan] ?></td>
                        <td class="text-center"><?= number_format($jumlah, 0, ',', '.') ?></td>
                        <td class="text-right">Rp <?= number_format($laporan['pendapatan_bulanan'][$bulan], 0, ',', '.') ?></td>
                    </tr>
                <?php endforeach;
            else : ?>
                <tr>
        ...
        <tfoot>
            <tr class="table-primary">
                ...
                <th class="text-center"><?= number_format($totalJumlahPembayaran, 0, ',', '.') ?></th>
