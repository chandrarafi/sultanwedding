<nav class="bg-white shadow-md">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="flex-shrink-0 flex items-center">
                    <a href="<?= site_url('pelanggan') ?>" class="flex items-center">
    ...
    <div class="mobile-menu hidden sm:hidden" id="mobile-menu">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <a href="<?= site_url('galeri') ?>" class="<?= strpos(current_url(), site_url('galeri')) !== false ? 'bg-primary-50 border-primary-500 text-primary-700' : 'border-transparent text-secondary-600 hover:bg-gray-50 hover:border-secondary-300 hover:text-secondary-800' ?> block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
                Galeri
            </a>
        </div>
        <div class="pt-4 pb-3 border-t border-gray-200">
            <div class="flex items-center px-4">
                ...
                <div class="ml-3">
                    <div class="text-base font-medium text-secondary-800"><?= $user['name'] ?? 'User' ?></div>
                    <div class="text-sm font-medium text-secondary-500"><?= $user['email'] ?? '' ?></div>
                </div>
            </div>
